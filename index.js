...
function setToArray(mySet) {
  ...
  const stringElements = newArr.filter((elem) => typeof elem === "string");
...
function removeDuplicatesInPlace(arr) {
  ...
  // Повертаємо множину
  const seen = new Set(); // Множина для збереження унікальних елементів
  let writePos = 0; // Позиція у масиві, куди буде записано наступний унікальний елемент
